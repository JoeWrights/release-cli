...
* Add support for customizable npm registry in release process and enhance commit type definitions with UI and improved descriptions ([a659fc6](https://github.com/JoeWrights/release-cli/commit/a659fc6a606da35628d3f7fa586b858d1dd13d1d))
...
* Enhance changelog generation by adding grouping and sorting options for commits ([4825c25](https://github.com/JoeWrights/release-cli/commit/4825c2506a100bc61c72856a303f6fc07ac96dd1))
...
* Simplify changelog generation by removing hardcoded sorting order and related logic for commit types ([4205811](https://github.com/JoeWrights/release-cli/commit/42058117fb2e06ac3662a10e05a6c337f80bf8ae))
...
* update commit type display names with emoji for better visual representation ([251dd4f](https://github.com/JoeWrights/release-cli/commit/251dd4f8627afbdb82ba6e1b0653950f87798bbf))
...
* add console logs for debugging package.json write and changelog generation ([fd9e514](https://github.com/JoeWrights/release-cli/commit/fd9e514342bbd2fd74c8e4e342c0c1db6d77fbd5))
* add console logs for npm package version check and package.json reading ([40a0fbd](https://github.com/JoeWrights/release-cli/commit/40a0fbd3a08d4f5efcb18a9065321f8dfc5594a7))
...
* comment out angular preset configuration and console log in changelog generation ([7b80cca](https://github.com/JoeWrights/release-cli/commit/7b80cca71f782d7261e38a0dcb29471fbee3bfc1))
* comment out angular preset import in changelog file ([463c7b0](https://github.com/JoeWrights/release-cli/commit/463c7b0719fd755d6e8e8d55bfedade1e3499715))
...
* simplify changelog sorting by using string-based title sorting for better performance ([bb5eeca](https://github.com/JoeWrights/release-cli/commit/bb5eecaa1e32ebea78b1142930f81c205af64442))
...
* update changelog generation to use angular preset ([5157f88](https://github.com/JoeWrights/release-cli/commit/5157f880041a570d5089cd9d960a82979365c909))
...
* v1.0.17 changelog [ci skip] ([273e476](https://github.com/JoeWrights/release-cli/commit/273e4762536e0f831d22b306dd0baf1f69dbf5b2))
* v1.0.17-alpha.0 changelog [ci skip] ([9a4f7ed](https://github.com/JoeWrights/release-cli/commit/9a4f7ed00da22f96e63224798c147d53fc1af0fd))
* v1.0.17-alpha.1 changelog [ci skip] ([220fa40](https://github.com/JoeWrights/release-cli/commit/220fa4051f2f6f1380e98a18fd8f454df2370faf))
* v1.0.17-alpha.2 changelog [ci skip] ([d7e45a4](https://github.com/JoeWrights/release-cli/commit/d7e45a46c0aa26093f04503a7b118774dbcd6686))
* v1.0.17-alpha.3 changelog [ci skip] ([b896521](https://github.com/JoeWrights/release-cli/commit/b8965212faafb2dd0a650cde72f125a8f5a3c6f9))
* v1.0.18 changelog [ci skip] ([068ece8](https://github.com/JoeWrights/release-cli/commit/068ece84dccde2f91ccda009f64cf5bbe4bf87e7))
* v1.0.18-alpha.0 changelog [ci skip] ([9f8080e](https://github.com/JoeWrights/release-cli/commit/9f8080e2d7eacdd7cb0d4ea4f75a49bf039cb6eb))
* v1.0.18-alpha.1 changelog [ci skip] ([d168aec](https://github.com/JoeWrights/release-cli/commit/d168aec0db60d83d8cc82348d96a82e2f1583afb))
* v1.0.19 changelog [ci skip] ([041e77e](https://github.com/JoeWrights/release-cli/commit/041e77e3076946b6aa21f86a9106d31932c15234))
* v1.0.19-alpha.0 changelog [ci skip] ([5e22c65](https://github.com/JoeWrights/release-cli/commit/5e22c65b80677efcc563f16b78a009e52e6d241c))
...
* v1.0.20 changelog [ci skip] ([07184b5](https://github.com/JoeWrights/release-cli/commit/07184b5c24326c20ef9185627f7489d81a017d1f))
* v1.0.20-alpha.0 changelog [ci skip] ([4eba84b](https://github.com/JoeWrights/release-cli/commit/4eba84be88fc8cf296523442e4d028694b7c0e80))
* v1.0.20-alpha.1 changelog [ci skip] ([ad08272](https://github.com/JoeWrights/release-cli/commit/ad082725931575dd9aae3ecff3b57ad1af2f14d9))
...
* Enhance configuration validation with npmRegistry and tagPrefix options, and improve commitTypeDisplayName handling ([75b4dc5](https://github.com/JoeWrights/release-cli/commit/75b4dc5be7d6af33058da2eea0d289826f1bf264))
